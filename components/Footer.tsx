      ...
      <div className="max-w-7xl mx-auto py-16 px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-y-12 gap-x-12">
          ...
          <div className="flex flex-col lg:pr-8">
            ...
            <p className="text-sm leading-relaxed text-gray-400 mb-6 whitespace-pre-line">
              {data.bio}
            </p>
            {/* Social Media Icons */}
            <div className="flex space-x-5 mb-6">
              <a href={data.facebook} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#FFD700] transition-all hover:-translate-y-1" aria-label="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/></svg>
              </a>
              <a href={data.instagram} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#FFD700] transition-all hover:-translate-y-1" aria-label="Instagram">
              ...
              <a href={data.twitter} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#FFD700] transition-all hover:-translate-y-1" aria-label="X (formerly Twitter)">
              ...
              <a href={data.tiktok} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#FFD700] transition-all hover:-translate-y-1" aria-label="TikTok">
              ...
              <a href={data.youtube} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#FFD700] transition-all hover:-translate-y-1" aria-label="YouTube">
